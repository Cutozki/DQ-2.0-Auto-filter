...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('✇ Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ ✇', url="https://t.me/+zVTBR3cta9c2NmU1")
                  ]]
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('♚ Bᴏᴛ Oᴡɴᴇʀ', callback_data="owner_info"),
                    InlineKeyboardButton('⌬ Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="https://t.me/+xzlsKDVgQUFkYWQ1")
                ],[
                    InlineKeyboardButton('〄 Hᴇʟᴘ', callback_data='help'),
                    InlineKeyboardButton('⍟ Aʙᴏᴜᴛ', callback_data='about'),
                    InlineKeyboardButton('Iɴʟɪɴᴇ Sᴇᴀʀᴄʜ ☌', switch_inline_query_current_chat='')
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="https://t.me/+xzlsKDVgQUFkYWQ1"),
                          InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url="https://t.me/+zVTBR3cta9c2NmU1")
                       ],[
                          InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/Cutozki")
                         ]
                        ]
                    )
                )
        ...
        reply_markup=InlineKeyboardMarkup(
            [
             [
              ...
              InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/t.me/Cutozki")
             ]
            ]
        )
    )
